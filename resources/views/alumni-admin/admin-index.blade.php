...
<body>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li>
                                <i class="menu-icon fa fa-th"></i><a href="{{ route('view-admin') }}">view-admins</a>
                            </li>
                            <li>
                                <i class="menu-icon fa fa-th"></i><a href="{{ route('role-assign') }}">role-assign
                                    Form</a>
                            </li>
                        </ul>
                    </li>
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media bg-flat-color-1" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="{{ asset('alumni_admin/images/avatar/1.jpg') }}"></span>
                                ...
                                <a class="dropdown-item media bg-flat-color-4" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="{{ asset('alumni_admin/images/avatar/2.jpg') }}"></span>
                                    <span class="message media-body">
                                ...
                                <a class="dropdown-item media bg-flat-color-5" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="{{ asset('alumni_admin/images/avatar/3.jpg') }}"></span>
                                    <span class="message media-body">
                                ...
                                <a class="dropdown-item media bg-flat-color-3" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="{{ asset('alumni_admin/images/avatar/4.jpg') }}"></span>
                                    <span class="message media-body">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            ...
                            <img class="user-avatar rounded-circle"
                                src="{{ asset('alumni_admin/images/avatar/1.jpg') }}" alt="User Avatar">
                        </a>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <h4 class="card-title mb-0">student ratio</h4>
                                <div class="small text-muted">October 2023</div>
                            </div>
                            <!--/.col-->
    ...
    <script src="{{ asset('alumni_admin/vendors/jqvmap/dist/jquery.vmap.min.js') }}"></script>

    <script src="{{ asset('alumni_admin/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js') }}"></script>
    <script src="{{ asset('alumni_admin/vendors/jqvmap/dist/maps/jquery.vmap.world.js') }}"></script>
    <script>
        (function($) {
            "use strict";
