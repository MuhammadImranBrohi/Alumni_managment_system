 ...
 <head>
     ...
     <meta name="description" content="Alumni Admin">
     ...
     <link rel="stylesheet" href="{{ asset('alumni_admin/vendors/chosen/chosen.min.css') }}">
 ...
 <body>
                 ...
                 <div class="col-sm-5">
                     <div class="user-area dropdown float-right">
                         ...
                         <div class="user-menu dropdown-menu">
                             <a class="nav-link" href="{{ asset('') }}"><i class="fa fa-user"></i> My
                                 Profile</a>
     ...
     <script src="{{ asset('alumni_admin/vendors/chosen/chosen.jquery.min.js') }}"></script>
